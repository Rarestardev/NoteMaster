...
import com.rarestardev.notemaster.activities.ShowAllCategoryActivity
...
fun CategoryListView(){
    ...
    Row (
        ...
        Text(
            ...
            modifier = Modifier
                .clickable {
                    context.startActivity(Intent(context, ShowAllCategoryActivity::class.java))
                }
                .padding(end = 12.dp)
        )
    }
        ...
        items(categories.take(10)) { category ->
            Box(
                modifier = Modifier
                    ...
                    .border(0.4.dp, MaterialTheme.colorScheme.onSecondary,MaterialTheme.shapes.small)
                    .clickable{
